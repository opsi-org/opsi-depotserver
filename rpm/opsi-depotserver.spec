...
Requires:       python-opsi >= 4.0 opsiconfd >= 4.0 opsipxeconfd >= 4.0 opsi-utils >= 4.0 opsi-linux-bootimage >= 20090927 samba sudo wget
%if 0%{?suse_version}
...
Source:         opsi-depotserver_4.0-2.tar.gz
