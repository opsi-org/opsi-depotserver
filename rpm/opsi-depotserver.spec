...
Requires:       python-opsi >= 4.0.5.1 opsiconfd >= 4.0.1 opsi-atftp opsipxeconfd >= 4.0 opsi-utils >= 4.0 opsi-linux-bootimage >= 20090927 samba sudo wget
...
Source:         opsi-depotserver_4.0.5.7-1.tar.gz
